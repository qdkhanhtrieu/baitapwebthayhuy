...
<html lang="en">
  ...
  <body>
    ...
    <section>
      <div class="container fixDisplay3">
        <div class="row">
          <div class="col"> <center> <h4> Sửa Lịch Trình Bay </h4>
            <script type="text/javascript" src="datepicker.js"></script> 
            <p> <form action="sualichbay.php" method="POST" >
                <div class="form-group">
                   <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> ID </label> </h6>
                   <select name='txtid' id="nhapid" class="form-control"> 
                             <option selected> <?php echo $_GET['id'] ?> </option> 
                  </select>
                  
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1"><h6> Mã Số Chuyến Bay </h6></label>
                  <input type="text" class="form-control" id="masochuyenbay" name = 'txtMaSoChuyenBay'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputPassword1"> Nơi Đi </label> <h6> 
                ...
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Nơi Đến </label> </h6>
                ...
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Hãng Bay </label> </h6>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="exampleInputEmail1"><h6> Giờ Khởi hành </h6></label>
                  <input type="text" class="form-control" id="giokhoihanh" placeholder="Nhập Giờ Khởi Hành" name = 'txttimestart'>
                </div>
                ...
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Giờ Đến </label> </h6>
                  <input type="text" class="form-control" id="gioiden" placeholder="Nhập Giờ Đến" name = 'txttimeend'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Giá Bay </label> </h6>
                  <input type="text" class="form-control" id="giabay" placeholder="Nhập Giá VÉ" name = 'txtgiabay'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Số Ghế </label> </h6>
                  <input type="text" class="form-control" id="soghe" placeholder="Nhập Số Ghế" name = 'txtsoghe'>
                </div>
                <button type="submit" class="btn btn-primary"> Sửa Lịch Trình Bay </button>
                </form> </p> </center> 
          </div>
          <div class="col">
