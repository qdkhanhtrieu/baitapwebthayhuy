              ...
              <thead>
                <tr>
                  <td> <center> Mã Số Chuyến Bay  <br> <br> <h6>
                   ...
                   <td> <a class="btn btn-primary" href="Xoanhungchuyenbay.php?id=<?= $row['id'] ?>" role="button"> Xóa </a> </td>
                   <td> <a class="btn btn-primary" href="Suanhungchuyenbay.php?id=<?= $row['id'] ?>" role="button"> Sửa </a> </td>
                </tr>
              </thead>
                  </div>
                </section> <br>
