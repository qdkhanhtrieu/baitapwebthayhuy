    ...
    <body>
      ...
      <section>
        <div class="container fixDisplay3">
          <div class="row">
            <div class="col"> <center> <h4>Đăng Nhập Thành Viên</h4>
              <p> <form action="tendangky.php" method="POST" >
                  <div class="form-group">
                    <label for="exampleInputEmail1">Tên Đăng Nhập</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name ='txtUsername'>
                    <small id="emailHelp" class="form-text text-muted">Nhập Email Của bạn.</small>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Password</label>
                    <input type="password" class="form-control" id="exampleInputPassword" name = 'txtPassword' >
                  </div>
                  <button type="submit" class="btn btn-primary">Đăng Nhập</button>
                  <a class="btn btn-primary" href="DangKy.php" role="button"> Đăng Ký </a>
                  </form> </p> </center> 
            </div>
            <div class="col">
