  ...
  <body>
    ...
    <div class="container-fluid">
     ...
     <section>
        ...
        <div class="row">
          <div class="col"> <center> <h4> Thanh Toán </h4> 
            <p> <form action="thanhtoanve.php" method="POST" >
                
                <div class="form-group">
                   <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Loại Thẻ </label> </h6>
                   <select name='txtthe' id="nhapthe" class="form-control"> 
                  ...
                  <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Số Tài Khoản </label> </h6>
                  <input type="text" class="form-control" id="nhapstk" placeholder="Nhập Số Tài Khoản" name ='txtstk'>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1"><h6> Ngày Hết Hạn </h6></label>
                  <input type="text" class="form-control" id="nhapngayhethan" placeholder="MM/YYYY" name = 'txtngayhethan'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> CVV </label> </h6>
                  <input type="number" class="form-control" id="nhapcvv" placeholder="Nhập CVV" name = 'txtcvv'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Họ Tên Chủ Thẻ </label> </h6>
                  <input type="text" class="form-control" id="nhaphoten" placeholder="Nhập Họ Tên" name = 'txthoten'>
                </div>
                <div class="form-group">
