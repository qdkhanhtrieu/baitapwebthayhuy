  ...
  <body>
    ...
    <section>
      <div class="container fixDisplay3">
        <div class="row">
          <div class="col"> <center> <h4>Đăng Ký</h4>
            <p> <form action="tendangnhap.php" method="POST" >
                <div class="form-group">
                  <label for="exampleInputEmail1"><h6> Tên Đăng Nhập </h6></label>
                  <input type="email" class="form-control" id="nhaphoten" placeholder="Nhập Tên Đăng Nhập" name = 'txtUsername'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputPassword1"> Password </label> <h6>
                  <input type="password" class="form-control" id="nhappass" placeholder="Nhập Mật Khẩu" name = 'txtPassword'>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nhapsdt" placeholder="Nhập Số Điện Thoại" name = 'txtPhone'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Số CMND </label> </h6>
                  <input type="text" class="form-control" id="nhapsocmnd" placeholder="Nhập Số CMND" name = 'txtBirthday'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Giới Tính </label> </h6>
                   <select name='txtSex' id="nhapgioitinh" class="form-control"> 
