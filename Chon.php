  ...
  <body>
             ...
             <?php
                 if (isset($_SESSION["Name"]))
                    ...
                    if (isset($_SESSION["AdminName"]))
                  {
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="CapNhatLichBay.php" > Hỗ Trợ Chuyến Bay </a>
                    </li>
    ...
    <div class="container-fluid">
     ...
     <section>
        ...
        <div class="row">
          <div class="col"> <center> <h4> Thông Tin Liên Hệ </h4> <p> Thông tin có dấu (*) là bắt buộc phải nhập. Xin quý khách vui lòng kiểm tra kỹ thông tin email, điện thoại để tránh bị sai sót. </p>
            <p> <form action="thongtindatve.php" method="POST" >
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Họ Và Tên </label> </h6>
                  <input type="text" class="form-control" id="nhaphoten" placeholder="Nhập Họ Và Tên" name ='txtFullname'>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1"><h6> Số Điện Thoại </h6></label>
                  <input type="number" class="form-control" id="nhapsdt" placeholder="Nhập Số Điện Thoại" name = 'txtPhone'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Số CMND </label> </h6>
                  <input type="number" class="form-control" id="nhapsocmnd" placeholder="Nhập Số CMND" name = 'txtCMND'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Email </label> </h6>
                  <input type="text" class="form-control" id="nhapemail" placeholder="Nhập Email" name = 'txtEmail'>
                </div>
                <div class="form-group">
                  <h6> <label for="exampleInputEmail1"> Địa Chỉ </label> </h6>
                  <input type="text" class="form-control" id="nhapdiachi" placeholder="Nhập Địa Chỉ" name = 'txtDiaChi'>
                </div>
