  ...
  <body>
    ...
    <section>
      <div class="container fixDisplay3">
        <div class="row">
          <div class="col"> <center> <h4> Tạo Lịch Trình Bay </h4>
            <script type="text/javascript" src="datepicker.js"></script> 
            <p> <form action="tendangkylichbay.php" method="POST" >
                <div class="form-group">
                  <label for="exampleInputEmail1"><h6> Mã Số Chuyến Bay </h6></label>
                  <input type="text" class="form-control" id="masochuyenbay" placeholder="Nhập Mã Số Chuyến Bay" name = 'txtMaSoChuyenBay'>
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary"> Tạo Lịch Trình Bay </button>
                </form> </p> </center> 
          </div>
          <div class="col">
